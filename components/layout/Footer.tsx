        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              Empowering farmers with innovative biostimulant technology that enhances food security, improves livelihoods, and restores environmental balance.
            </p>
          ...
          {/* Products */}
          <div>
            <h4 className="font-semibold text-white mb-5 text-base">Our Products</h4>
            <ul className="space-y-2.5">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/40 text-sm text-center">
            © {currentYear} Shiv Biotech. All rights reserved.
          </p>
