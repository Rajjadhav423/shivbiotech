  ...
  return (
    <section className="py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-linear-to-br from-primary via-primary to-primary-dark rounded-3xl p-10 md:p-16 overflow-hidden text-center">
          ...
          {[...Array(4)].map((_, i) => (
            <motion.div
              ...
              style={{ left: `${15 + i * 22}%`, top: `${10 + (i % 2) * 60}%` }}
